...
// function renderLinePlot_2(data, dayNum = null) {
//     // Filter by day if specified
//     if (dayNum !== null) {
//         data = data.filter(d => +d.day === +dayNum);
//     }
...
//     d3.select("#chart").html(""); // Clear previous plot
...
// let rawData = await loadData('cleaned_data/all_temp.csv');
// let prepped = preprocessData(rawData, 'hour');  // or 'day'
// renderLinePlot_2(prepped, 1);  // day filter
import * as d3 from 'https://cdn.jsdelivr.net/npm/d3@7.9.0/+esm';
